...
parser.add_argument('--log_dir', default='checkpoint/PU_basis', help='Log dir [default: checkpoint/PU_basis]')
...
if __name__ == '__main__':
    ...
    load_model_dir = 'checkpoints/PU_basis/ppunet_epoch_***.pth'  # here type in the model you want to continue training
    ...
    for epoch in range(start_epoch,args.max_epoch):
        ...
        if (epoch ) % 2 == 0:
            ...
            save_path = os.path.join(args.log_dir, 'ppunet_epoch_{}.pth'.format(epoch))

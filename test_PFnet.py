...
for i, data in enumerate(test_dataloader, 0):
    ...
    print('[%d/%d] Loss: %.4f  full point loss: %.4f  skeleton loss: %.4f center loss: %.4f repulsion loss: %.4f'
...
print('average loss: Loss: %.4f  full point loss: %.4f  skeleton loss: %.4f center loss: %.4f repulsion loss: %.4f'
